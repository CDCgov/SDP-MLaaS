...
A [Source-to-Image (S2I)](https://github.com/openshift/source-to-image) implementation for a CentOS image that executes an [R](https://www.r-project.org/about.html) based application that includes [Python 3.6](https://www.python.org/downloads/release/python-366/).
...
We then inject our R webservice using this new image building a new image `mitre/r-plumber-mlaas`:
